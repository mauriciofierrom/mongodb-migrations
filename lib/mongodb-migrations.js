...
(function() {
  ...
  Migrator = (function() {
    ...
    Migrator.prototype.migrate = function(direction, done, progress) {
      this._runWhenReady(direction, done, progress);
    };
    ...
    Migrator.prototype.runFromDir = function(dir, direction, done, progress) {
      return this._loadMigrationFiles(dir, (function(_this) {
        return function(err, files) {
          ...
          return _this.migrate(direction, done, progress);
        };
      })(this));
    };
